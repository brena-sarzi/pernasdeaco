...
<div class="container">
    <div class="row">
        <div class="cart col-xl-8 col-12">
...
<div class="cart-collaterals">
	...
	<?php if ( wc_coupons_enabled() ) { ?>
		<div class="coupon">
			<input form="woocommerce-cart" type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Código do cupom', 'woocommerce' ); ?>" />
